                      ...
                      <div class="panel-heading">
                           <div class="row">
	                        ...
	                        <div class="formstyle">
	                        	<form action="">	
	                        		<div>
	                        			 <input type="text" size="5px"value="공지" readonly="readonly" style="text-align: center;"/>
	                        			<input type="text" size="120px" style="margin-bottom: 10px;" value="일반게시판 글입니다" readonly="readonly"/>
	                        		</div>
  									<table>
  										<tfoot>
  											<tr>
  											...
  											<tr>
  												<td colspan="5">
  													<textarea rows="10px" cols="132px" readonly="readonly">어이가 없다 어이가 없어</textarea>
  												</td>
  											</tr>
  										</tfoot>
  									</table>		
