	...
	function exe(value,np){
		...
		$.ajax({
			...
			$.each(data.b_list, function(index, item){
				...
				str += "<div class='col-lg-3 col-md-4 col-sm-6 portfolio-item'><div class='card h-100'><a href='searchDetail.inc?isbn="+item.isbn13+"'><img class='card-img-top' src="+item.bookImageURL+"></a><div class='card-body'><h4 class='card-title'><a href='searchDetail.inc?isbn="+item.isbn13+"'>"+item.bookname+"</a></h4></div></div></div>";
